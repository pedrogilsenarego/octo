...
export const categories: Category[] = [
  {
    ...
    moreInfo: {
      description:
        "Our Sleeping Bag is a lightweight and cozy option that's suitable for use from birth. It's designed to fit perfectly in the carrycot of a stroller, as well as in a cuckoo or cradle. The sleeping bag is equipped with two side loops for easy access and the top can be closed in a hood shape with two ties to protect your baby. The filling gives a soft and fluffy feel that's gentle to the touch.<br /><br />  Crafted in cotton and bambula. ",
      dimensions: "Size: 75 x 45 cm",
      washing:
        "Suitable for washing in a washing machine. Do not exceed 30º to prevent damage to the fabric. Do not use a dryer",
    },
  },
  {
    id: 1,
    ...
    moreInfo: {
      description:
        "Our baby cot protectors are designed to provide a safe and comfortable sleeping environment for your little one. <br /><br />Crafted in cotton.",
  ...
  },
  {
    ...
    moreInfo: {
      description:
        "Our baby cot organizer is designed to help you keep all your baby's essentials organized. Simply attach the organizer to the side of your baby's cot using the three secure straps and fill the pockets with all your baby's necessities. You'll have everything you need within arm's reach, making bedtime changes a breeze.<br /><br /> Crafted in cotton.",
...

  {
    ...
    moreInfo: {
      description:
        "Our maternity bag is not only practical and lightweight, but also versatile enough to double as a weekend bag. It features a waterproof interior, along with two interior pockets and baby bottle holders to help you stay organized while on the go. For added convenience, the bag comes with a detachable shoulder strap and our signature yellow zip closure.<br /><br />  Crafted in cotton.  ",
  ...
  },
  {
    ...
    moreInfo: {
      description:
        "This is our Stroller Pocket, designed to be lightweight and easy to carry. With a detachable shoulder strap and our signature yellow zip closure, it's padded to protect your belongings inside. The bag can be attached to your pram's handlebars with snaps or used as a compact walking bag. It’s perfect for daily use!<br /><br />   Crafted in cotton. ",
...

  {
    ...
    moreInfo: {
      description:
        "Our washcloth is an excellent way to keep your baby's clothes dry from drool, ensuring maximum comfort and avoiding potential irritation. It fastens with a snap button and offers two different positions to adjust the size of the neck circunference. Crafted in cotton.",
      dimensions: "N.A.",
      washing:
        "Suitable for washing in a washing machine. Do not exceed 30º to prevent damage to the fabric. Do not use a dryer",
    },
  ...
  },
  {
    ...
    moreInfo: {
      description:
        "Our Laundry Kit is the perfect solution for storing clean and dirty clothes when you're on the go. Our kit includes two bags: one that have the interior made of waterproof material to keep dirty clothes separate from clean ones, and the other is made of soft, breathable material to store clean clothes. Ideal for travel, daycare, or trips to the park.<br /><br /> Crafted in cotton. ",
