...
export const categories:Category[] = [
  {
    ...
    price: 34,
    moreInfo: {
      description: "Our Sleeping Bag is a lightweight and cozy option that's suitable for use from birth. It's designed to fit perfectly in the carrycot of a stroller, as well as in a cuckoo or cradle. The sleeping bag is equipped with two side loops for easy access and the top can be closed in a hood shape with two ties to protect your baby. The filling gives a soft and fluffy feel that's gentle to the touch. <br/> Crafted in cotton and bambula. ",
...
},
{
  ...
  price: 34,
  moreInfo: {
    description: "Our baby cot organizer is designed to help you keep all your baby's essentials organized. Simply attach the organizer to the side of your baby's cot using the three secure straps and fill the pockets with all your baby's necessities. You'll have everything you need within arm's reach, making bedtime changes a breeze. <br/>Crafted in cotton.",
  ...
  
  {
    ...
    price: 34,
    moreInfo: {
      description: "Our maternity bag is not only practical and lightweight, but also versatile enough to double as a weekend bag. It features a waterproof interior, along with two interior pockets and baby bottle holders to help you stay organized while on the go. For added convenience, the bag comes with a detachable shoulder strap and our signature yellow zip closure. <br/>Crafted in cotton.  ",
