...
},
{
  ...
  price: 34,
  moreInfo: {
    description: "Our baby cot organizer is designed to help you keep all your baby's essentials organized. Simply attach the organizer to the side of your baby's cot using the three secure straps and fill the pockets with all your baby's necessities. You'll have everything you need within arm's reach, making bedtime changes a breeze.<br /><br /> Crafted in cotton.",
