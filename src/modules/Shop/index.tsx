    ...
    <>
      ...
      >
        <Typography fontSize="20px" style={{ marginTop: mobile ? "150px" : "0px" }}>
          We're thrilled that our website is up and run, but we're sorry to say that you're not able to shop just yet. We're working hard to put the finishing touches on our online store so that you can have the best shopping experience possible.<br />
